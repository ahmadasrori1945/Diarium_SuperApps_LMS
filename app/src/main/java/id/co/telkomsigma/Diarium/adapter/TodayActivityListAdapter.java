...
//            }
            ...
            switch (type) {
                case "00":
                    typeResult = "To Do";
                    holder.ivType.setImageResource(R.drawable.list);
                    break;
                case "01":
                    typeResult = "In Progress";
                    holder.ivType.setImageResource(R.drawable.load);
                    break;
                case "02":
                    typeResult = "Pending";
                    holder.ivType.setImageResource(R.drawable.pending);
                    break;
                case "03":
                    typeResult = "Done";
                    holder.ivType.setBackgroundResource(R.drawable.done);
                    break;
                case "04":
                    typeResult = "Cancel";
                    holder.ivType.setBackgroundResource(R.drawable.canceled);
                    break;
            }
