...
import id.co.telkomsigma.Diarium.adapter.EmployeeCareReplyAdapter;
...
import id.co.telkomsigma.Diarium.model.EmployeeCareReplyModel;
...
public class DetailEmployeeCareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title = intent.getStringExtra("problem_type");
...
//                                session.setToken(response.getString("token"));
                                ...
                                for (int a = 0; a < jsonArray.length(); a++) {
                                    ...
                                    for (int j=0;j<arrayName.length();j++) {
                                        ...
                                        String name = objName.getString("full_name");
