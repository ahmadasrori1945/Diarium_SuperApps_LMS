package id.co.telkomsigma.Diarium.controller.more.survey;
...
import id.co.telkomsigma.Diarium.adapter.SurveyAdapter;
import id.co.telkomsigma.Diarium.controller.LoginActivity;
import id.co.telkomsigma.Diarium.model.SurveyModel;
...
//        tvNull = (TextView) findViewById(R.id.tvNull);
    ...
    private void getSurvey(){
        ...
        AndroidNetworking.get(session.getServerURL()+"users/getAllEmployeeSurvey/buscd/"+session.getUserBusinessCode())
...
//                                    tvNull.setVisibility(View.VISIBLE);
                                    for (int a = 0; a < jsonArray.length(); a++) {
                                        ...
                                        String enddate_survey = object.getString("enddate_survey");
