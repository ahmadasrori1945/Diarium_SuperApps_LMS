...
import id.co.telkomsigma.Diarium.adapter.TemplateKuisionerAdapter;
import id.co.telkomsigma.Diarium.adapter.TesAdapter;
import id.co.telkomsigma.Diarium.model.MateriLMSModel;
import id.co.telkomsigma.Diarium.model.TemplateKuisionerModel;
import id.co.telkomsigma.Diarium.model.TesModel;
                        ...
                        try {
                            ...
                            if (jsonArray.length()==0) {
                                ...
                                for (int a = 0; a < jsonArray.length(); a++) {
                                    ...
                                    modelTes = new TesModel(template_name,type);
