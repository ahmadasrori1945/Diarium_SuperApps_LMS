package id.co.telkomsigma.Diarium.controller.home.main_menu.mytime.checkin;
...
//        progressDialogHelper.showProgressDialog(CheckinActivity.this, "Getting data...");
    ...
    private void checkIn() {
        ...
        AndroidNetworking.upload(session.getServerURL()+"users/"+session.getUserNIK()+"/presensi/"+session.getUserNIK()+"/buscd/"+session.getUserBusinessCode())
