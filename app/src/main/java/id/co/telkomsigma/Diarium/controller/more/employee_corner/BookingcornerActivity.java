package id.co.telkomsigma.Diarium.controller.more.employee_corner;
...
import id.co.telkomsigma.Diarium.adapter.DetailCornerAdapter;
...
//                Toast.makeText(BookingcornerActivity.this, "Tanggal : "+hasilFrom+" - "+session.getEmpId(), Toast.LENGTH_SHORT).show();
    ...
    private void getDetailCorner(final String date, String ecrid){
        ...
        AndroidNetworking.get(session.getServerURL()+"users/showdetailbydate/date/"+date+"/ecrid/"+ecrid+"?")
